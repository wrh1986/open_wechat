...
public class MenuUtils {
  ...
  public static String getRedirectUrl(WechatAccount account, String url) throws UnsupportedEncodingException {
    return account.getWebBaseUrl() + "/com/tomato/wechat/redirect.action?url=" + URLEncoder.encode(url, "UTF-8");
  }

  public static String getOAuthUrl(WechatAccount account, String url) throws UnsupportedEncodingException {
    return URLManager.getUrl_OAuthRedirect(account.getWebBaseUrl() + url, account.getAppId());
  }
